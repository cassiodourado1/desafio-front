<template>
  <div class="home">
    ...
    <div class="home__container">
      ...
      >Sem Resultados, refaça sua busca</p>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    searchByTerm(searchTerm) {
      ...
      this.resultList = this.links.filter(
        item =>
          item.category === this.term ||
          item.meta.title.includes(this.term) ||
          item.meta.url.includes(this.term) ||
          item.meta.author.includes(this.term)
      );
    }
  }
};
